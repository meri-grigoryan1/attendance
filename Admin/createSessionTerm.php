...
if(isset($_POST['save'])){
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>Այս տվյալներով ուս․ տարին և կիսամյակը գոյություն ունեն</div>";
    }
    else{
    ...
    if ($query) {
        ...
        $statusMsg = "<div class='alert alert-success'  style='margin-right:700px;'>Հաջողությամբ ստեղծված է </div>";
    }
    else
    {
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ստեղծել ուս․ տարի և կիսամյակ</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Տուն</a></li>
              <li class="breadcrumb-item active" aria-current="page">Ստեղծել ուս․ տարի և կիսամյակ</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Ստեղծել ուս․ տարի և կիսամյակ</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Ուս․ տարի<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="sessionName" value="<?php echo $row['sessionName'];?>" id="exampleInputFirstName" placeholder="Session">
                        ...
                        <div class="col-xl-6">
                            <label class="form-control-label">Կիսամյակ<span class="text-danger ml-2">*</span></label>
                              <?php
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Բոլոր ուս․ տարիները և կիսամյակները</h6>
                  <h6 class="m-0 font-weight-bold text-danger">Նշում․ <i>Սեղմեք ստուգանիշի վրա՝ ուս․ տարին և կիսամյակը ընտրելու համար</i></h6>
                </div>
