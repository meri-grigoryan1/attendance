 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap"
          ...
          <span>Կառավարել կուրսերը</span>
        </a>
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Կառավարել կուրսերը</h6>
            <a class="collapse-item" href="createClass.php">Ստեղծել բաժին</a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrapusers"
          ...
          <span>Կառավարել կուրերը</span>
        </a>
        <div id="collapseBootstrapusers" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Կառավերլ բաժինները</h6>
            <a class="collapse-item" href="createClassArms.php">Ստեղծել բաժին</a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrapassests"
          ...
          <span>Կառավերլ դասախեսներին</span>
        </a>
        <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Կառավերել դասախոսներին</h6>
             <a class="collapse-item" href="createClassTeacher.php">Ստեղծել դասախոսներ</a>
