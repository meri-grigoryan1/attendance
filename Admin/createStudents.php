...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>Այս էլ․ հասցեով գրանցումը արդեն գոյություն ունի:</div>";
    }
    else{
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ստեղծել ուսանող</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Տուն</a></li>
              <li class="breadcrumb-item active" aria-current="page">Ստեղծել ուսանող</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Ստեղծել ուսանող</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Անուն<span class="text-danger ml-2">*</span></label>
                        <input type="text" class="form-control" name="firstName" value="<?php echo $row['firstName'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Ազգանուն<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="lastName" value="<?php echo $row['lastName'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Հայրանուն<span class="text-danger ml-2">*</span></label>
                        <input type="text" class="form-control" name="otherName" value="<?php echo $row['otherName'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Ընդունելության համարը<span class="text-danger ml-2">*</span></label>
                    ...
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Ընտրել բաժին<span class="text-danger ml-2">*</span></label>
                         <?php
                    ...
                    {
                    ?>
                    <button type="submit" name="update" class="btn btn-warning">Խմբագրել</button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <?php
                    } else {           
                    ?>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Բոլոր ուսանողները</h6>
                </div>
