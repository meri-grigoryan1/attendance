    ...
    if ($query) {
        ...
        $qu=mysqli_query($conn,"update tblclassarms set isAssigned='1' where Id ='$classArmId'");
            if ($qu) {
                ...
                $statusMsg = "<div class='alert alert-success'  style='margin-right:700px;'>Հաջողությամբ ստեղծել է</div>";
            }
            else
            {
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ստեղծել դասախոս</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Տուն</a></li>
              <li class="breadcrumb-item active" aria-current="page">Ստեղծել դասախոս</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Ստեղծել դասախոս</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Էլ․ հասցե<span class="text-danger ml-2">*</span></label>
                        <input type="email" class="form-control" required name="emailAddress" value="<?php echo $row['emailAddress'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Հեռախոսահամար<span class="text-danger ml-2">*</span></label>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Բոլոր դասախոսները</h6>
                </div>
